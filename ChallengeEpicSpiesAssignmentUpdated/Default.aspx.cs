...
namespace ChallengeEpicSpiesAssignment
{
    public partial class Default : System.Web.UI.Page
    {
        ...
        protected void assignButton_Click(object sender, EventArgs e)
        {
            ...
            if (totalDurationOfAssignment.TotalDays > 42)
            {
                totalCost += 1000.0;
            }
            ...
            // if cost exceeds €50000,- give case manager message
            if (totalCost > 50000.0)
            {
                resultLabel.Text = " Budget exceeds €50000,- contact Case Manager for permission!!!!";
            }
